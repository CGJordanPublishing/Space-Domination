...
\draw (0,0) node {\includegraphics[scale=2]{StarshipGreen.png}};
\draw (2,0) node {\includegraphics[scale=2]{StarshipRed.png}};
\draw (4,0) node {\includegraphics[scale=2]{StarshipBlue.png}};
\draw (6,0) node {\textbf{Starships}};
\draw (6,-1.75) node {\textbf{Torpedoes}};
\draw (0,-1.5) node {\includegraphics[scale=1.5]{torpedo.png}};
\draw (2,-1.5) node {\includegraphics[scale=1.5]{torpedo.png}};
\draw (4,-1.5) node {\includegraphics[scale=1.5]{torpedo.png}};
\draw (0.5,-2) node {\includegraphics[scale=1.5]{torpedo.png}};
\draw (2.5,-2) node {\includegraphics[scale=1.5]{torpedo.png}};
\draw (4.5,-2) node {\includegraphics[scale=1.5]{torpedo.png}};
\draw (-0.5,-2) node {\includegraphics[scale=1.5]{torpedo.png}};
\draw (1.5,-2) node {\includegraphics[scale=1.5]{torpedo.png}};
\draw (3.5,-2) node {\includegraphics[scale=1.5]{torpedo.png}};
